...
public class DialogFragmentPassword extends DialogFragment {
    ...
    /**
     * we check if the password is correct and with it we create actions according to its answer
     * @param passwordTextField we receive password from the activity with user
     */
